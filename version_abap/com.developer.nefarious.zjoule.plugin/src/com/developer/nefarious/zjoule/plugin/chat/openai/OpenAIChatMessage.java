 ...
 * The {@code OpenAIChatMessage} class implements {@link IChatMessage} and 
...
public class OpenAIChatMessage implements IChatMessage {
    ...
    /**
     * Default constructor for creating an empty {@code OpenAIChatMessage}.
     */
    public OpenAIChatMessage() { }

    /**
     * Constructs a new {@code OpenAIChatMessage} with the specified role and content.
     *
